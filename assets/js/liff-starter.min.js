...
function initLiff() {
    console.log("going to initialize LIFF"), liff.init(e => {
        ...
        liff.getProfile().then(e => {
            ...
            console.info("User name is", t), "yes" == getParameterByName("auto") && sendLiffMessage(), document.getElementById("greet").innerHTML = "Hi, " + t + " ౼ Nice to meet you"
